...
# load data
miss_ghg_data <- read_csv(here("data", "mississuaga_ghg_emitters.csv"))
...
Here, we have data for 13 distinct greenhouse gas emitting sites in the city of Mississuaga, and we have data for these sites between the years 2010 and 2018. Can you tell what each row represents?
...
filter(miss_ghg_data, facility_name %in% c("Mississauga Cement Plant",
  ...
  labs(x = "Year", 
       ...
       color = "Facilty Name",
       title = "Top 3 Mississuaga GHG Emitters Over Time") +
  scale_y_continuous(labels = comma) +
...
- [R for Data Science](https://r4ds.had.co.nz/) is a great overview of one framework for doing data work in R, including data preparation which was done behind the scenes. 
