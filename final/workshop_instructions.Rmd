...
# load data
miss_ghg_data <- read_csv("mississauga_ghg_emitters.csv")
facility_emissions <- read_csv("facilty_aggregates.csv")
owner_emissions <- read_csv("owner_aggregates.csv")
yearly_emissions <- read_csv("year_aggregates.csv")
...
- My [GitHub Repo of Data Prep](https://github.com/grahamammal/Mississuaga-Workshop) might be of interest to people who want to see data cleaning in action. Warning! Some of the manipulations done are a little fancy!
